...
<div class="row" style="clear: both;display: none;margin: auto;width: 40%;" id="service_interface">
	...
	<div style="float:right;margin:5px;">
		<input id="add_service_text" name="add_service_text" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="" placeholder="請輸入服務名稱" required="required">
	</div>
	<div style="float:right;margin:5px;">
