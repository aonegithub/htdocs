...
<div class="row">
	<div class="input-group input-group-sm col-md-6">
		...
		<div class="radio radio-inline align-middle">
		    <input type="radio" id="invoce0" value="0" name="invoce" checked="">
		    <label for="invoce0">可</label>
		</div>
		<div class="radio radio-inline align-middle">
		    <input type="radio" id="invoce1" value="1" name="invoce">
		    <label for="invoce1">僅開立收據</label>
		</div>
		<div class="radio radio-inline align-middle">
		    <input type="radio" id="invoce2" value="2" name="invoce">
		    <label for="invoce2">皆無</label>
		</div>
	</div>
	<!-- ** -->
	<div class="input-group input-group-sm col-md-6">
	...
	<table class="tg" style="width: 100%">
	  ...
	  <tr>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入姓名" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入職稱" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入電話" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入手機" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入LineID" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入微信" value="">
	    </td>
	    <td style="height:45px;">
	    	<input type="text" class="form-control" id="area_name" name="area_name" placeholder="請輸入信箱" value="">
	    </td>
	  </tr>
	</table>
</div>
	    ...
	    <td colspan="6">
	    	<div class="row col-md-12">
	    		<div class="input-group input-group-sm col-md-2">
					...
					<input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_com" name="contact_com" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_job" name="contact_job" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-5">
					...
					<select class="form-control col-md-2" id="contact_area_level1" name="contact_area_level1" style="display:none">
					  	<option value='1'>台灣</option>
				  	</select>
				  	<select class="form-control col-md-2" id="contact_area_level2" name="contact_area_level2" onchange="login_chg_area(this,2)">
					  	<option value='-1'>-</option>
					  	@foreach($Areas_level2 as $key => $area2)
							<option value='{{$area2->nokey}}'>{{$area2->area_name}}</option>
					  	@endforeach
				  	</select>
				  	<select class="form-control col-md-2" id="contact_area_level3" name="contact_area_level3">
						<option value='-1'>-</option>
					</select>
					<input type="text" class="form-control col-md-8" id="contact_addr" name="contact_addr" placeholder="請輸入地址" value="">
				</div>
	    	</div>
	    </td>
	  </tr>
	    ...
	    <td colspan="6">
	    	<div class="row col-md-12">
	    		<div class="input-group input-group-sm col-md-2">
					...
					<input type="text" class="form-control" id="contact_tel" name="contact_tel" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_mobile" name="contact_mobile" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_email" name="contact_email" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_id" name="contact_id" placeholder="" value="">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-2">
				    <div class="input-group-prepend">
					...
					<input type="text" class="form-control" id="contact_passwd" name="contact_passwd" placeholder="" value="">
				</div>
	    	</div>
	    </td>
	  </tr>
	    ...
	    <td colspan="6">
			<div class="row col-md-12">
	    		<div class="input-group input-group-sm col-md-6">
					...
					<input type="text" class="form-control" id="login_global_name" name="login_global_name" placeholder="集團名稱" value="">與
					<input type="text" class="form-control" id="login_global_url" name="login_global_url" placeholder="" value="http://">
				</div>
				<!-- ** -->
				<div class="input-group input-group-sm col-md-6">
				    <div class="input-group-prepend">
...
<div class="row">
	...
	<div class="input-group input-group-sm col-md-6">
		...
		<input type="text" class="form-control" id="d_surl" name="d_surl" placeholder="" value="2020-09-19">
	</div>
	<!-- ** -->
	<div class="input-group input-group-sm col-md-6">
	    <div class="input-group-prepend">
